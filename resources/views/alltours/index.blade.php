...
<!-- Mirrored from www.ansonika.com/panagea/tours-grid-isotope.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jan 2024 15:03:06 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
			...
			<ul>
				<li><span><a href="#0">Home</a></span>
					<ul>
						...
						<li><a href="index-20.html">Categories Effect <strong class="badge text-bg-danger">New!</strong></a></li>
						<li><a href="index-21.html">Categories Effect 2 <strong class="badge text-bg-danger">New!</strong></a></li>
						<li><a href="index-22.html">Categories Search <strong class="badge text-bg-danger">New!</strong></a></li>
						<li>
						...
						<li><a href="index-10.html">Search 3</a></li>
				...
				<li><span><a href="#0">Extra</a></span>
					<ul>
						<li><a href="html_rtl/index.html">RTL Version</a></li>
			...
			<div class="row">
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid" data-cue="slideInUp">
						<figure>
							...
							<a href="tour-detail.html"><img src="images/img1/tour_1.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item latest">
					<div class="box_grid" data-cue="slideInUp">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="tour-detail.html"><img src="images/img1/tour_2.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid" data-cue="slideInUp">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="tour-detail.html"><img src="images/img1/tour_3.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
							<small>Historic</small>
						</figure>
						<div class="wrapper">
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item latest">
					<div class="box_grid" data-cue="slideInUp">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="tour-detail.html"><img src="images/img1/tour_4.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
							<small>Museum</small>
						</figure>
						<div class="wrapper">
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid" data-cue="slideInUp">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="tour-detail.html"><img src="images/img1/tour_5.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
							<small>Walking</small>
						</figure>
						<div class="wrapper">
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item latest">
					<div class="box_grid" data-cue="slideInUp">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="tour-detail.html"><img src="images/img1/tour_6.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
							<small>Museum</small>
						</figure>
						<div class="wrapper">
	...
	<script src="js/js1/markerclusterer.js"></script>
	<script src="js/js1/map_tours.js"></script>
	<script src="js/js1/infobox.js"></script>
	
	<!-- Masonry Filtering -->
	<script src="js/js1/isotope.min.js"></script>
	<script>
	...
	<!-- COLOR SWITCHER  -->
    <script src="js/js1/switcher.js"></script>
...
<!-- Mirrored from www.ansonika.com/panagea/tours-grid-isotope.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jan 2024 15:03:08 GMT -->
</html>