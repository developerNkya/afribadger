<header class="transform translate-3d fixed top-0 z-app w-full bg-gradient-0-darken">
    ...
    <div
        ...
        <nav class="items-center ml-30 hidden lg:flex">
            ...
            </a><a href="discover.html"
                class="block h-40 px-10 lg:border-1 lg:border-transparent lg:rounded-2 text-white lg:hover:border-white-50">
                <div class="h-full flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        class="h-20 w-20 mr-10 transition-color transition-250 text-yellow">
                        <path
                            d="M12.707.707l10.586 10.586a1 1 0 010 1.414L12.707 23.293a1 1 0 01-1.414 0L.707 12.707a1 1 0 010-1.414L11.293.707a1 1 0 011.414 0zm.445 16.414h-2.243a1 1 0 00-.79 1.613l.083.094 1.121 1.122a1 1 0 001.32.083l.095-.083 1.12-1.122a1 1 0 00-.706-1.707zm-6.41-6.919a1 1 0 00-1.414 0l-1.12 1.121a1 1 0 000 1.415l1.12 1.12a1 1 0 001.708-.706v-2.243a1 1 0 00-.293-.707zm11.38-.293a1 1 0 00-.994.884l-.007.116v2.243a1 1 0 001.613.79l.094-.083 1.122-1.121a1 1 0 00.083-1.32l-.083-.095-1.122-1.12a1 1 0 00-.707-.294zm-6.704-5.785l-.095.083-1.12 1.121a1 1 0 00.59 1.7l.116.008h2.243a1 1 0 00.79-1.613l-.083-.095-1.121-1.12a1 1 0 00-1.32-.084z"
                            fill="currentColor"></path>
                    </svg>
                    <span> Discover </span>
                </div>
            </a><a href="sign/in14dd.html"
                class="block h-40 px-10 lg:border-1 lg:border-transparent lg:rounded-2 text-white lg:hover:border-white-50">
                <div class="h-full flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        class="h-20 w-20 mr-10 transition-color transition-250 text-yellow">
                        <g fill="none" fill-rule="evenodd">
                            <path stroke="currentColor" stroke-linecap="square"
                                d="M7.5 10.5h7m-11 3h7m0-3v8m-3-13V13"></path>
                            <path
                                d="M23 2a1 1 0 011 1v18a1 1 0 01-1 1H1a1 1 0 01-1-1V3a1 1 0 011-1h22zM8.337 6.21l-.094.083-4.95 4.95a1 1 0 00-.083 1.32l.083.094 4.95 4.95a1 1 0 001.32.083l.094-.083 4.95-4.95a1 1 0 00.083-1.32l-.083-.094-4.95-4.95a1 1 0 00-1.32-.083zM19.232 6h-1.464a.732.732 0 00-.518 1.25l.543.543a1 1 0 001.414 0l.543-.543A.732.732 0 0019.232 6z"
                                fill="currentColor" fill-rule="nonzero"></path>
                        </g>
                    </svg>
                    <span> Community </span>
                </div>
            </a><a href="index.html#get-the-ios-app"
                class="block h-40 px-10 lg:border-1 lg:border-transparent lg:rounded-2 text-white lg:hover:border-white-50">
                <div class="h-full flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        class="h-20 w-20 mr-10 transition-color transition-250 text-yellow">
                        <path
                            d="M5.5 1.5a1 1 0 011-1h10a1 1 0 011 1v21a1 1 0 01-1 1h-10a1 1 0 01-1-1v-21zm5 20.5a1 1 0 102 0 1 1 0 00-2 0z"
                            fill="currentColor" fill-rule="nonzero"></path>
                    </svg>
        ...
        <div class="ml-auto hidden lg:block">
            <div class="flex items-center">
                <a href="sign/in.html"
                    class="block h-40 px-10 hover:text-pink-primary flex items-center text-white"><span
                        class="truncate w-full"> Login </span></a>
                <div class="h-15 border-l-1"></div>
                <a href="sign/up.html"
                    class="block h-40 px-10 hover:text-pink-primary flex items-center text-white"><span
                        class="truncate w-full"> Register </span></a>
            </div>
        </div>
        <!---->
        <div class="w-20"></div>
