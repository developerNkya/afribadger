<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <script>document.write(new Date().getFullYear())</script> © Camel Leon.
            </div>
            <div class="col-sm-6">
...
<!-- Mirrored from themesdesign.in/Camel Leon-ajax/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Aug 2023 22:30:07 GMT -->
</html>