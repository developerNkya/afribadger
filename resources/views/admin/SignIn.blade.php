                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-9">
                                        <div>
                                            ...
                                            <div class="p-2 mt-5">
                                                <form class="" action="https://themesdesign.in/nazox-ajax/layouts/index.html">
                                            ...
                                            <div class="mt-5 text-center">
                                                ...
                                                <p>© <script>document.write(new Date().getFullYear())</script> Nazox. Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="https://1.envato.market/themesdesign" target="_blank">Themesdesign</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
